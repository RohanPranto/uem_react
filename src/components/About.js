...
export default function About() {
  ...
  return (
    <div className="container main">
      <div className="row">
      <div className="col-lg-7 profile mobile_view">
          <h3>
            ...
            <div className="col-lg-3">
              ...
              <div className="dropdown show  drop2">
                ...
                >
                  ...
                  <Link className="dropdown-item" to="/admit">
                    Admit Card
                  </Link>
                  <Link className="dropdown-item" to="/forget">
                    Change Password
                  </Link>
            ...
            <div className="col-lg-9">
              <div className="row row2 flex-column flex-md-row">
                <div className="col-lg-6 col-sm-6 col-12">
                  <Link to="/result">
                    <button className="butn">Unit Test Details</button>
                  </Link>
                  <Link to="/attendance">
                    <button className="butn">Attendance</button>
                  </Link>
                  <Link to="/calender">
                    <button className="butn">Organisational Calendar</button>
                  </Link>
                  <Link to="/info">
                    <button className="butn">My Information</button>
                  </Link>
                  <Link to="/fees">
                    <button className="butn">Fees</button>
                  </Link>
                </div>
                <div className="col-lg-6 col-sm-6 col-12">
                  <Link to="/feedback">
                    <button className="butn">Sem Feedback</button>
                  </Link>
                  <Link to="/admit">
                    <button className="butn">Admit card</button>
                  </Link>
                  <button className="butn">Exam Form</button>
                  <Link to="/forget">
                  ...
                  <Link to="/">
                    <button className="butn">LogOut</button>
                  </Link>
                </div>
              </div>
            </div>
  ...
  <td colSpan={2}>{new Date().toLocaleDateString('en-US', { weekday: 'long' })}</td>
</tr>
        ...
        <div className="col-lg-7 profile laptop_view">
          <h3>
            Welcome, <span>Jerry</span>
          </h3>
          <p>Your Computer Number Is 298.178.20.01</p>
